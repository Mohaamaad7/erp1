...
.fa-cog , .fa-building{color: #ea1212 !important;
...
ul.tmenu {	/* t r b l */
    ...
    ul.tmenu li {
        border-left: 2px solid #176295; /* Set the desired width and color for the left border */
        border-radius: 5px; /* Set the border radius if you want rounded corners */
    }
