...
/**
 *		\file       htdocs/theme/reyada_blue/style.css.php
 *		\brief      File for CSS style sheet reyada_blue
 */
...
$theme = 'reyada_blue'; // Value of theme
...
// Define image path files and other constants
    ...
    $fontlist = 'tahoma,arial,verdana,helvetica'; //$fontlist='helvetica, verdana, arial, sans-serif';


//$fontlist = 'verdana,helvetica, tahoma,arial'; //$fontlist='helvetica, verdana, arial, sans-serif';
$img_head = '';
...
//$conf->global->THEME_REYADA_BLUE_ENABLE_PERSONALIZED=0;
//$user->conf->THEME_REYADA_BLUE_ENABLE_PERSONALIZED=0;
//var_dump($user->conf->THEME_REYADA_BLUE_RGB);
