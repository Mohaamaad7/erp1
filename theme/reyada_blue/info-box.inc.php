 ...
 */
    ...
    .fa-dol-commande,
    .fa-dol-facture,
    .fa-dol-order_supplier,
    .fa-dol-invoice_supplier,
.fa-dol-bank_account,.fa-barcode,
    .fa-concierge-bell,
    .fa-box-open,
    .fa-cubes,
    .fa-cube,
...
.info-box {
    ...
    width: 100%;
	box-shadow: 1px 1px 4px rgba(0, 0, 0, 0.98);
...
.info-box .progress .progress-bar {
    ...
    .info-box-icon {
        ...
        background: linear-gradient(to left, #2F80ED, #56CCF2); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
         /* تغيير لون الأيقونات إلى اللون الأبيض */
    }
...
.bg-infobox-propal, .bg-infobox-facture, .bg-infobox-commande {
	<?php echo $prefix; ?>color: #ffffff !important;
}
...
.bg-infobox-expensereport{
	<?php echo $prefix; ?>color: #ffea00 !important;
}
.bg-infobox-holiday{
...
.infobox-holiday ,.fa-handshake{
	color: #f710ff !important;
}
