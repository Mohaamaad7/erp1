...
// ***************************************************************************************************************
//
// -------------------- >>> ajax action après Drag&Drop d'une tuile ==> mise à jour du "Status" de l'objet
//
if ($action == 'cardDrop') {
...
//
// --------------------- >>> ajax action countryChange,  on remplit la liste des départements du pays
//
...
$kanbanHeaderCounts			 = array(); // si action ajax, ce tableau permet la mise à jour du nbre de prospects de chaque colonne
...
// ***************************************************************************************************************
//
// suite de l'ajax action if ($action == 'cardDrop')
if ($action == 'cardDrop') {
...
print '<form name="listactionsfilter" id="listactionsfilter" action="' . $_SERVER["PHP_SELF"] . '" method="post">';
