...
/**
 * 	\defgroup   Internal Notification     Module InternalNotification
 *  \brief      module InternalNotification descriptor.
 *  \file       \htdocs\internalnotification\core\modules\modInternalNotification.class.php
 *  \ingroup    internalnotification
 *  \brief      Description and activation file for module InternalNotification
 */
 ...
 */
class modInternalNotification extends DolibarrModules {
    ...
    function __construct($db) {
        ...
        $this->rights_class = 'internalnotification';
        ...
        $this->description = "Envoi de notifications lors de certaines actions ( Evènements, tiers et contacts )";
        ...
        $this->config_page_url = array("internalnotification.php@internalnotification");
        ...
        $this->langfiles = array("internalnotification@internalnotification");
        ...
        // Dictionaries
        if (!isset($conf->internalnotification->enabled)) {
            $conf->internalnotification = new stdClass();
            $conf->internalnotification->enabled = 0;
        }
    ...
    function init($options = '') {
        ...
        $result = $this->_load_tables('/internalnotification/sql/');
