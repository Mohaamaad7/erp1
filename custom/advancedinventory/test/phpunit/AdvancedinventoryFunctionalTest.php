...
/**
 * \file    test/phpunit/AdvancedinventoryFunctionalTest.php
...
/**
 * Class AdvancedinventoryFunctionalTest
 *
 ...
 *
 * @package Testadvancedinventory
 */
class AdvancedinventoryFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modAdvancedinventory')->click();
		} else {
			// Disable the module
			$this->byHref('modAdvancedinventory')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/advancedinventory/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('advancedinventory/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/advancedinventory/admin/about.php');
		$this->authenticate();
		return $this->assertContains('advancedinventory/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('advancedinventorywidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAdvancedinventory_AdvancedinventoryTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAdvancedinventory_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
